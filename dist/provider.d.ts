import { Connection, Account, PublicKey, Transaction, TransactionSignature, ConfirmOptions, RpcResponseAndContext, SimulatedTransactionResponse } from "@solana/web3.js";
/**
...
export default class Provider {
     ...
     * @param opts    Transaction confirmation options.
     */
    simulate(tx: Transaction, signers?: Array<Account | undefined>, opts?: ConfirmOptions): Promise<RpcResponseAndContext<SimulatedTransactionResponse>>;
}
